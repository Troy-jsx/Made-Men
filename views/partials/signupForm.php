<form class="flex flex-col gap-10 absolute aspect-[600/650] h-[700px]">
    <label class='font-koho font-bold tracking-koho text-7xl text-shadow-lg/40'>Sign Up</label>

    <div class='flex flex-col gap-6 w-fit'>
        
        <div class='flex flex-col gap-1'> 
            <label class='font-koho font-bold tracking-koho text-4xl text-shadow-lg/40'>Email Address</label>
            <input type="email" name="email" placeholder="eg: mobster@mob.com" class="caret-mmRed w-full px-4 py-1 bg-transparent border-3 shadow-xl/40 border-inputGrey rounded-sm font-inter font-medium text-3xl focus:outline-none">
        </div>
