        ...
        <div class="w-[60%] flex flex-col sm:gap-3 lg:gap-2 justify-center h-full">
            <div class="flex flex-col text-left justify-between">
                ...
                <div class="flex flex-row justify-between w-full">
                    <h1 class="font-koho tracking-koho font-bold text-2xl sm:text-2xl md:text-3xl lg:text-4xl drop-shadow-lg/20 text-black text-left w-full">Pickpocketing</h1>
                    <h1 class="text-koho text-money-green font-bold tracking-koho text-4xl">$600</h1>
                </div>
            </div>
            <div class="flex flex-row justify-between">
                <h1 class="font-inter tracking-koho font-medium text-md  sm:text-md md:text-lg lg:text-xl drop-shadow-md/20 text-black/90 text-left w-full">Teach members pickpocketing skills.</h1>
            </div>
        </div>
    </div>
