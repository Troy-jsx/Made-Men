<div class="group border-black flex flex-col border-4 gap-5 sm:px-4 px-2 py-1 sm:py-2 md:px-6 md:py-3 lg:px-8 lg:py-4 rounded-xl cursor-default select-none">
    <h1 class="font-koho tracking-koho font-bold text-2xl sm:text-2xl md:text-3xl lg:text-5xl text-black text-center w-full">The Ishikawa-kai</h1>
    <div class="flex flex-row gap-2 lg:gap-4 items-center justify-center">
        <div class="bg-[url('../public/img/bosses/Ishikawa.png')] bg-cover w-[30%] aspect-square bg-amber-50 rounded-md border-border-brown border-4">
